...
bempp.api.global_parameters.hmat.eps=1E-04;
...
[bem_c,trace_matrix]=simple_ngbem.p1_trace(V);

bem_dc=bempp.api.function_space(bem_c.grid,'DP',0);
...
block[0,0]=simple_ngbem.NgOperator(a);
...
p_block[0,0]=simple_ngbem.NgOperator(c,a);
